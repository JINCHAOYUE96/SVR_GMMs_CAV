...
raw_data = pd.read_csv(r'C:\Users\a\Desktop\SVR-GMMs-Kanto\SVR_GMMs_CAV\CAV\DataCAV2.csv',encoding='GBK')
...
writer_xunlian=pd.ExcelWriter(r'C:\Users\a\Desktop\SVR-GMMs-Kanto\SVR_GMMs_CAV\CAV\train.xls')
...
writer_ceshi=pd.ExcelWriter(r'C:\Users\a\Desktop\SVR-GMMs-Kanto\SVR_GMMs_CAV\CAV\test.xls')
...
model_svr = SVR(kernel="rbf",gamma=0.279,C=1.816,epsilon=0.06) # Set the hyperparameters of SVR GMMs
model_names = ['SVR']
model_dic = [model_svr]
cv_score_list = []
pre_y_list = []
...
new_pre_SVR_y = []
raw_data = pd.read_csv(r'C:\Users\a\Desktop\SVR-GMMs-Kanto\SVR_GMMs_CAV\CAV\shujv2222-11.csv',encoding='GBK') # input the information for prediction (R,M,Vs30)
